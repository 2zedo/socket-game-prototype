...
- Branch: `main`
- Current commit at task start: `2d54aa7`
- Phase: Hacking FX atlas region mapping criteria
...
3. `hack_fx_atlas.png` asset 제작과 FX region viewer prototype 적용을 별도 작업으로 진행한다. 시작 문서는 `docs/HACK_FX_ATLAS_REGION_MAPPING.md`, `docs/HACK_ARENA_TILES_ATLAS_REGION_MAPPING.md`, and `docs/HACKING_ACTION_PROTOTYPE_IMPLEMENTATION.md`이며, 완료 기준은 FX/body atlas separation, stable animation anchors, cyber feedback readability, blend / alpha visibility against arena tiles, and non-fantasy effect direction이 확인되는 것이다.
