...
- All seven direct-interaction objects are Scene-Node-backed in ROTATE_90; the remaining eleven environment footprints stay Resource-backed with script fallback and additive Inspector custom entries preserved.
...
- Apartment shell data still uses the 18-object rotated-floorplan candidate; all seven direct-interaction objects expose exact pixel geometry in the Scene Inspector while category/anchor semantics and the other eleven environment footprints remain Resource-driven.
